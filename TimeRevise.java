...
public class TimeRevise extends JFrame
{
	...
	void setFrame()
	{
		...
		beginBox.add(beginYear);beginBox.add(new Label("年"));
		beginBox.add(beginMonth);beginBox.add(new Label("月"));
		beginBox.add(beginDay);beginBox.add(new Label("日"));

		endBox.add(Box.createHorizontalStrut(40));
		endBox.add(endTime);endBox.add(Box.createHorizontalStrut(10));
		endBox.add(endYear);endBox.add(new Label("年"));
		endBox.add(endMonth);endBox.add(new Label("月"));
		endBox.add(endDay);endBox.add(new Label("日"));
